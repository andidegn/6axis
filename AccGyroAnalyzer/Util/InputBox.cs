...
namespace ECTunes.CustomInputBox {
	...
	public class InputBox {
		...
		public static ComboBox cbbInput;
		...
		private static void InitializeComponent() {
			...
			lblPrompt.Location = new Point(12, 9); // 12, 9
			...
			btnOK.Location = new Point(326, 8); // 326, 8
			btnOK.Name = "btnOK";
			...
			btnCancel.Location = new Point(326, 40); // 326, 40
			...
			// txtInput
			// 
			txtInput.Location = new Point(8, 100); // 8, 100
			...
			// cbbInput
			// 
			cbbInput.Location = new Point(8, 100); // 8, 100
			cbbInput.Name = "cbbInput";
			cbbInput.Size = new Size(79, 20);
			cbbInput.DropDownStyle = ComboBoxStyle.DropDownList;

			bool empty = true;
			foreach (string port in Util.SerialPortConnector.getAvalComPort()) {
				cbbInput.Items.Add(port);
				empty = false;
			}
			if (!empty)
				cbbInput.SelectedIndex = 0;
			...
			frmInputDialog.Controls.Add(cbbInput);
		...
		static private void btnOK_Click(object sender, System.EventArgs e) {
			...
			OutputResponse.Text = cbbInput.SelectedItem.ToString();
